...
// Here we override the native bar chart draw method to support
// the drawing of rounded rectangles in bar charts

// This code is adapted from https://github.com/jedtrow/Chart.js-Rounded-Bar-Charts/blob/master/Chart.roundedBarCharts.js
const originalDraw = (ChartJS as any).elements.Rectangle.prototype;

(ChartJS as any).elements.Rectangle.prototype.draw = function () {
